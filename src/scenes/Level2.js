...
class Level2 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.anims.create({
      key: "P9",
      frames: [{ key: CST.PLANTSPRITE.PLANTS, frame: 9 }],
      frameRate: 20
    });
  ...
  create() {
    this.add
      .image(0, 0, CST.IMAGE.FOREST)
      .setOrigin(0, 0)
      .setScale(3);

    this.add.image(600, 440, CST.IMAGE.TREE4).setScale(4);
    this.add.image(500, 65, CST.IMAGE.TREE3).setScale(4);
    this.add.image(190, 220, CST.IMAGE.BUSH2).setScale(4);
    this.add.image(650, 170, CST.IMAGE.BUSH3).setScale(4);
    ...
    platforms
      .create(400, 590, CST.IMAGE.PLATFORM2)
      .setScale(4)
      .refreshBody();
    platforms
      .create(200, 450, CST.IMAGE.PLATFORM2)
      .setScale(2)
      .refreshBody();
    platforms
      .create(50, 270, CST.IMAGE.PLATFORM2)
      .setScale(2)
      .refreshBody();
    platforms
      .create(700, 220, CST.IMAGE.PLATFORM2)
      .setScale(2)
      .refreshBody();

    sunflower = this.physics.add
      .sprite(100, 105, CST.PLANTSPRITE.PLANTS)
      .setScale(4);
    ...
    tulip = this.physics.add
      .sprite(100, 300, CST.PLANTSPRITE.PLANTS)
      .setScale(4);
